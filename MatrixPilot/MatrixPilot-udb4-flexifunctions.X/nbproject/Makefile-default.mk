...
${OBJECTDIR}/_ext/1812019833/polar_data.o: C:/mav/MatrixPilot-Software/MatrixPilot_fbw/MatrixPilotFBW/polar_data.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1812019833 
	@${RM} ${OBJECTDIR}/_ext/1812019833/polar_data.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE)  C:/mav/MatrixPilot-Software/MatrixPilot_fbw/MatrixPilotFBW/polar_data.c  -o ${OBJECTDIR}/_ext/1812019833/polar_data.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1812019833/polar_data.o.d"        -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=coff -legacy-libc -mlarge-code -O0 -I"../../MAVLink/include" -I".." -I"../../libUDB" -I"../../libDCM" -I"../../MAVLink/include/common" -I"../../MAVLink/include/matrixpilot" -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/1812019833/polar_data.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
