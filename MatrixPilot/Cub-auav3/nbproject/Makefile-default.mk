...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Cub-auav3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ProjectDir=/media/ubuntu_32/home/markw/MPLABXProjects/newsvn/MatrixPilot_mw4fbw/MatrixPilot/Cub-auav3
ConfName=default
ImagePath=dist/default/${IMAGE_TYPE}/Cub-auav3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
ImageDir=dist/default/${IMAGE_TYPE}
ImageName=Cub-auav3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
.build-conf:  .pre ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Cub-auav3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1077471063/estWind.o: ../../libDCM/estWind.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../../libDCM/estWind.c  -o ${OBJECTDIR}/_ext/1077471063/estWind.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1077471063/estWind.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -legacy-libc -mlarge-code -mlarge-data -mconst-in-code -O0 -I"./projectSpecific" -I"../../MAVLink/include" -I".." -I"../../libUDB" -I"../../libDCM" -I"../../libFlashFS" -I"../../MAVLink/include/common" -I"../../MAVLink/include/matrixpilot" -I"../../Microchip/Include" -msmart-io=1 -Wall -msfr-warn=on -mno-eds-warn
...
${OBJECTDIR}/_ext/1077471063/estWind.o: ../../libDCM/estWind.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1077471063/estWind.o.d 
	@${RM} ${OBJECTDIR}/_ext/1077471063/estWind.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../../libDCM/estWind.c  -o ${OBJECTDIR}/_ext/1077471063/estWind.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1077471063/estWind.o.d"      -mno-eds-warn  -g -omf=elf -legacy-libc -mlarge-code -mlarge-data -mconst-in-code -O0 -I"./projectSpecific" -I"../../MAVLink/include" -I".." -I"../../libUDB" -I"../../libDCM" -I"../../libFlashFS" -I"../../MAVLink/include/common" -I"../../MAVLink/include/matrixpilot" -I"../../Microchip/Include" -msmart-io=1 -Wall -msfr-warn=on -mno-eds-warn
	@${FIXDEPS} "${OBJECTDIR}/_ext/1077471063/estWind.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Cub-auav3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../VectorMatrix.X/dist/AUAV3/production/VectorMatrix.X.a ../Microchip_Library_Apps.X/dist/AUAV3/production/Microchip_Library_Apps.X.a  
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Cub-auav3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}    ../VectorMatrix.X/dist/AUAV3/production/VectorMatrix.X.a ../Microchip_Library_Apps.X/dist/AUAV3/production/Microchip_Library_Apps.X.a  -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -legacy-libc -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--heap=200,--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${IMAGE_TYPE}.map"$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Cub-auav3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../VectorMatrix.X/dist/AUAV3/production/VectorMatrix.X.a ../Microchip_Library_Apps.X/dist/AUAV3/production/Microchip_Library_Apps.X.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Cub-auav3.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}    ../VectorMatrix.X/dist/AUAV3/production/VectorMatrix.X.a ../Microchip_Library_Apps.X/dist/AUAV3/production/Microchip_Library_Apps.X.a  -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -legacy-libc -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--heap=200,--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${IMAGE_TYPE}.map"$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}/xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Cub-auav3.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf 
