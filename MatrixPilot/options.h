#define THISFIRMWARE "MxPilotPlane APS3099.bz2k.t114"  // WIP add to telemetry log 

/*  TEST RELEASE# T011fw, UDB4-UDB5 Breeze V-tail glider airframe
 *  
 *  Modifications :
 *  
 *  WIP - Add Sonar AGL altitude enhanced LOGO, navigation and deadreckoning modules using Pete and Robert's codes as baseline
 *  
 ...
 *
 *  >>>>>> : 1) Test/Mod Barometer algorithm to work and fuse with altitude management
 *           2) Dev. database (mavlink compliant) parameter definitions for settings, finetuning (P,D,I)params
 *           3) Enable-Test Wifi communication, check WiFly (SparkFun) viability as substitute to XBee
 *           4) Research, phase-in interactive GCS (mavlink protocol) capabilitiess
 *
 *  RELEASE NOTES:
 *  
 *  Baseline Trunk Commit: 3099
