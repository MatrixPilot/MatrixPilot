...
// 
#define AILERON_CHANNEL_REVERSED            1 // 0 for breeze vtail glider, 1 for standard, 0 for delta/wing
#define ELEVATOR_CHANNEL_REVERSED           0 // 1 for breeze vtail glider, 0 for standard, 1 for delta/wing
#define RUDDER_CHANNEL_REVERSED             1 // 0 for breeze vtail glider, 1 for standard, 1 for delta/wing
...
////////////////     II.3. BAROMETER PRESSURE (ALTIMETER) AND TEMPERATURE SUPPORT    ///////////////
//
...
// Note: Use Pa, a measure of force per unit area, defined as one newton per square meter.
//       Common multiple units of the Pascal are the hectopascal (1 hPa = 100 Pa), 
...
// testing observations: SPI option doesn't seem to work on UDBx
#define USE_OSD_SPI     				0  // see release notes on SPI use on UDB4
...
#define FLIGHT_PLAN_TYPE                    FP_LOGO //FP_WAYPOINTS  //

// Uncomment to use dynamic waypoints with a GCS. ..under testing, use only with FP_WAYPOINTS FLIGHT_PLAN_TYPE
...
// With LOGO_COMPLEX, AUTO MODE invokes LOGO fight plan with pattern and properties 
//   controlled from a radio TX,  while in flight
//#define LOGO_TYPE                    		LOGO_COMPLEX  //WIP, to accommodate an option for beginners
