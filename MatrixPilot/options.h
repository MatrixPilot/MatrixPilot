...
#define RUDDER_SECONDARY_INPUT_CHANNEL                  CHANNEL_4
...
#define RUDDER_SECONDARY_OUTPUT_CHANNEL                 CHANNEL_4
...
// Set this to 1 if you need to switch the Rudderon VTOL surfaces
...
#define ID_VEHICLE_MODEL_NAME "Gemini001"
