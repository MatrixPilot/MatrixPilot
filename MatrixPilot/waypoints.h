...
#define WAYPOINT_RADIUS                 5       //was 25
...
#define FIXED_ORIGIN_LOCATION   { -1216455400, 365983700, 100.0 }       // near middle of field behind my house in Salinas, CA
//#define FIXED_ORIGIN_LOCATION { -1217151320, 365800380, 100.0 }       // middle of cow field behind San Benancio school, Salinas, CA
//#define FIXED_ORIGIN_LOCATION { -1216457690, 365996600, 30.0 }        // middle of field behind my house in Salinas, CA
//#define FIXED_ORIGIN_LOCATION { -1217910400, 366493200, 100.0 }       // middle of antenna field at CSUMB in Seaside, CA

#define CAM_VIEW_1 {0, 1000, 0} //1000 meters to the north of the startup location - CAM_VIEW {east, north, altitude}
/*
const struct waypointDef waypoints[] = {
        { {   100,   110, 100 } , F_NORMAL, CAM_VIEW_1 } , // 0
} ;
*/
...
///////////////////////////////////////////////////////////////////////////////
// F_CROSS_TRACK turned on
// 04/21/2013 waypoint set for DIYDrones T3 competition
// Optimized to achieve smooth turns and to minimize the travel distance.
// DIYDones T3 competition course using relative waypoints (~1200 meter travel distance)
// Travels along a Figure-8 course around the corners of a square (200 meters per side).
///////////////////////////////////////////////////////////////////////////////
/*
const struct waypointDef waypoints[] = {
        { {   100,   110, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 0
        { {   110,   105, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 1
        { {   117,    95, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 2
        { {   120,    85, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 3
        { {   120,   -85, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 4
        { {   117,   -95, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 5
        { {   110,  -105, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 6
        { {   100,  -110, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 7
        { {    90,  -110, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 8
        { {    80,  -105, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 9
        { {    60,   -85, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 10
        { {     0,     0, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 11
        { {   -60,    85, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 12
        { {   -80,   105, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 13
        { {   -90,   110, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 14
        { {  -100,   110, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 15
        { {  -110,   105, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 16
        { {  -117,    95, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 17
        { {  -120,    85, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 18
        { {  -120,   -85, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 19
        { {  -117,   -95, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 20
        { {  -110,  -105, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 21
        { {  -100,  -110, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 22
        { {   -90,  -110, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 23
        { {   -80,  -105, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 24
        { {   -60,   -85, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 25
        { {     0,     0, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 26
        { {    60,    85, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 27
        { {    80,   105, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 28
        { {    90,   110, 100 } , F_CROSS_TRACK, CAM_VIEW_LAUNCH } , // 29
} ;
*/
///////////////////////////////////////////////////////////////////////////////
// 11/30/2011 waypoint set for DIYDrones T3 competition
// Optimized to achieve smooth turns and to minimize the travel distance.
// DIYDones T3 competition course using relative waypoints (~1200 meter travel distance)
// Travels along a Figure-8 course around the corners of a square (200 meters per side).
///////////////////////////////////////////////////////////////////////////////
/*
const struct waypointDef waypoints[] = {
        { {   100,   110, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 0
        { {   110,   105, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 1
        { {   117,    95, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 2
        { {   120,    85, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 3
        { {   120,   -85, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 4
        { {   117,   -95, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 5
        { {   110,  -105, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 6
        { {   100,  -110, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 7
        { {    90,  -110, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 8
        { {    80,  -105, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 9
        { {    60,   -85, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 10
        { {     0,     0, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 11
        { {   -60,    85, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 12
        { {   -80,   105, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 13
        { {   -90,   110, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 14
        { {  -100,   110, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 15
        { {  -110,   105, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 16
        { {  -117,    95, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 17
        { {  -120,    85, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 18
        { {  -120,   -85, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 19
        { {  -117,   -95, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 20
        { {  -110,  -105, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 21
        { {  -100,  -110, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 22
        { {   -90,  -110, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 23
        { {   -80,  -105, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 24
        { {   -60,   -85, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 25
        { {     0,     0, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 26
        { {    60,    85, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 27
        { {    80,   105, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 28
        { {    90,   110, 100 } , F_NORMAL, CAM_VIEW_LAUNCH } , // 29
} ;
*/

///////////////////////////////////////////////////////////////////////////////
// Example showing the use of absolute waypoints
// using latitude, longitude and altitude points.
// Flys a 4 point counter clockwise pattern over
// the horse field next to my house in Salinas, CA
///////////////////////////////////////////////////////////////////////////////
/*
const struct waypointDef waypoints[] = {
        { { -1216469000, 365995000, 100 }, F_ABSOLUTE } ,
        { { -1216456000, 365983200, 100 }, F_ABSOLUTE } ,
        { { -1216439100, 365992400, 100 }, F_ABSOLUTE } ,
        { { -1216459800, 366007800, 100 }, F_ABSOLUTE } ,
        { { -1216464600, 365959600, 200 }, F_ABSOLUTE } ,
        { { -1216507300, 365996100, 200 }, F_ABSOLUTE } ,
} ;
*/
...
// Example showing the use of absolute waypoints
// using latitude, longitude and altitude points.
// Flys a course from the edge of horse field to
// the edge of the Indians Springs entrance and back
///////////////////////////////////////////////////////////////////////////////
/*
const struct waypointDef waypoints[] = {
        { { -1216459800, 366007800, 200 }, F_ABSOLUTE } ,
        { { -1216405600, 365999200, 200 }, F_ABSOLUTE } ,
        { { -1216360400, 365995700, 200 }, F_ABSOLUTE } ,
        { { -1216318000, 366004000, 200 }, F_ABSOLUTE } ,
        { { -1216347500, 366020300, 200 }, F_ABSOLUTE } ,
        { { -1216389200, 365975100, 200 }, F_ABSOLUTE } ,
        { { -1216419100, 365948400, 200 }, F_ABSOLUTE } ,
} ;
*/
