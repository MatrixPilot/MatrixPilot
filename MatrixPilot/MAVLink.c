...
// Mavlink Aviation Y axis is out of the right wing, and so is the negative of the UDB X Axis
...
*/
	    ...
	    case MAVLINK_MSG_ID_WAYPOINT_CLEAR_ALL:
	    {
	        ...
	        //for (int16_t i=0;i<3;i++) mavlink_msg_waypoint_ack_send(chan,msg->sysid,msg->compid,type);
