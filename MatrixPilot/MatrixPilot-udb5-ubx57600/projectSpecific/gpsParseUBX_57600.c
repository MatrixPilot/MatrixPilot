...
const char bin_mode_withnmea[] = "$PUBX,41,1,0003,0003,57600,0*21\r\n"; // turn on UBX + NMEA, 57600 baud
const char bin_mode_nonmea[] = "$PUBX,41,1,0003,0001,57600,0*23\r\n";   // turn on UBX only, 57600 baud
...
void msg_B3(uint8_t gpschar)
{
	...
	else if (dcm_flags._.nmea_passthrough && gpschar == '$' && udb_gps_check_rate(57600))
	{
