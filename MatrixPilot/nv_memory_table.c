...
const mavlink_parameter_block    mavlink_parameter_blocks[] = {
    ...
    { STORAGE_HANDLE_NAV_OPTIONS , 57 , 4 , STORAGE_FLAG_LOAD_AT_STARTUP | STORAGE_FLAG_LOAD_AT_REBOOT , NULL },
    { STORAGE_HANDLE_CONTROL_GAINS_LOAD , 61 , 2 , STORAGE_FLAG_LOAD_AT_STARTUP | STORAGE_FLAG_LOAD_AT_REBOOT , NULL },
    };
