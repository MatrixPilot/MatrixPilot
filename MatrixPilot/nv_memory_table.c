...
const mavlink_parameter_block    mavlink_parameter_blocks[] = {
    ...
    { STORAGE_HANDLE_RADIO_TRIM , 22 , 11 , STORAGE_FLAG_LOAD_AT_STARTUP | STORAGE_FLAG_LOAD_AT_REBOOT | STORAGE_FLAG_STORE_CALIB , &udb_skip_radio_trim },
    ...
    { STORAGE_HANDLE_AIRSPEED_OPTIONS , 47 , 10 , STORAGE_FLAG_LOAD_AT_STARTUP | STORAGE_FLAG_LOAD_AT_REBOOT , NULL },
    };
