...
${OBJECTDIR}/_ext/1658199856/read.o: ../../libCommon/read.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../../libCommon/read.c  -o ${OBJECTDIR}/_ext/1658199856/read.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1658199856/read.o.d"        -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -legacy-libc -mlarge-code -mlarge-data -O0 -I"../../MAVLink/include" -I"../../libUDB" -I"../../libDCM" -I"../../MAVLink/include/common" -I"../../MAVLink/include/matrixpilot" -I"../../MatrixPilot" -I"../../libFlashFS" -I"../../Microchip/Include" -msmart-io=1 -Wall -msfr-warn=off
