...
int expected_glide_descent_rate(int16_t airspeed, minifloat aoa)
{
...
int feedforward_climb_rate(fractional throttle, int16_t glide_descent_rate, int16_t airspeed)
{
