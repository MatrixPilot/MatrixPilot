...
#define ALMOST_ENOUGH_SAMPLES   20 // HeartBeat=200Hz (5ms for 6 channels 833%s/channel ) 833/39
#define ADCLK_DIV_N_MINUS_1     49  // ADC Conversion Clock Tad=Tcy*(ADCS+1)= (1/32M)*50 = 1.56us (640 KHz)
                                    // ADC Conversion Time for 12-bit Tc=14*Tad = 22us
#define ADSAMP_TIME_N           11   // 11 Tad waitings between samples (11+14)*1.56=39µs (25.6 KHz)
#else
