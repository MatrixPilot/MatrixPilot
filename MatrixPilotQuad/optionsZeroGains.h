...
#define GAIN_FACTOR 0.0

// Tilt PID(DD) control gains
#define TILT_KI 0.05*GAIN_FACTOR
#define TILT_KP 0.08*GAIN_FACTOR
#define TILT_KD 0.5*GAIN_FACTOR
#define TILT_KDD 0.8*GAIN_FACTOR

// Yaw PID control gains
#define YAW_KI 0.5*GAIN_FACTOR
#define YAW_KP 0.3*GAIN_FACTOR
#define YAW_KD 3.0*GAIN_FACTOR


// Vertical damping 
// ****Note*** if your ESCs work "backwards", meaning that faster speed requires shorter pulses, then flip the sign to minus
#define ACCEL_K 1.0*GAIN_FACTOR
