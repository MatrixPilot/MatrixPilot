...
extern int cos_lat ;
# 23 "../../libDCM/estYawDrift.c" 2
# 33 "../../libDCM/estYawDrift.c"
void udb_magnetometer_callback_data_available( void )
{
...
void estYawDrift(void)
{
 ...
 {
  if ((estimatedWind[0] == 0 && estimatedWind[1] == 0) || air_speed_magnitudeXY < 200 )
  {
