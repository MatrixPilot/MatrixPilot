...
# 23 "../../libUDB/servoOut.c" 2
# 1 "../../libUDB/../libDCM/libDCM.h" 1
# 26 "../../libUDB/../libDCM/libDCM.h"
# 1 "../../libUDB/../libDCM/../libUDB/libUDB.h" 1
# 27 "../../libUDB/../libDCM/libDCM.h" 2
# 1 "../../libUDB/../libDCM/libDCM_defines.h" 1
# 27 "../../libUDB/../libDCM/libDCM_defines.h"
...
# 28 "../../libUDB/../libDCM/libDCM.h" 2
# 41 "../../libUDB/../libDCM/libDCM.h"
void dcm_init( void ) ;
...
# 24 "../../libUDB/servoOut.c" 2
# 83 "../../libUDB/servoOut.c"
inline int scale_pwm_out(int channel) {
    union longww pww;
    pww.WW = __builtin_muluu(udb_pwOut[channel], (unsigned int)(65536 * ((80000000) / 32E6) / 4));
    pww.WW <<= 2;
    return pww._.W1;
}
