...
# 23 "../../libUDB/libUDB.c" 2

void run_background_task(void);

extern struct ADchannel primaryV;
# 63 "../../libUDB/libUDB.c"
__attribute__((section("__FOSCSEL.sec"),space(prog))) int _FOSCSEL = (0xFFFB);;
__attribute__((section("__FOSC.sec"),space(prog))) int _FOSC = (0xFFBF & 0xFFFF & 0xFFFD);;
# 73 "../../libUDB/libUDB.c"
__attribute__((section("__FWDT.sec"),space(prog))) int _FWDT = (0xFF7F & 0xFFFF);;


__attribute__((section("__FGS.sec"),space(prog))) int _FGS = (0xFFFF & 0xFFFF & 0xFFFF);;



__attribute__((section("__FPOR.sec"),space(prog))) int _FPOR = (0xFFF8);;
__attribute__((section("__FICD.sec"),space(prog))) int _FICD = (0xFFDF & 0xFFFE);;
...
void udb_init_leds(void) {
    ...
    TRISEbits.TRISE1 = 0; TRISEbits.TRISE2 = 0; TRISEbits.TRISE3 = 0; TRISEbits.TRISE4 = 0;
    LATEbits.LATE1 = 1; LATEbits.LATE2 = 1; LATEbits.LATE3 = 1; LATEbits.LATE4 = 1;
...
void udb_a2d_record_offsets(void) {
    ...
    udb_zaccel.offset = udb_zaccel.value -((int) (2 * ((long)(5280.0/2.64))));
...
int udb_servo_pulsesat(long pw) {
    if (pw > 3000 + ((int)(1.0*1000))) pw = 3000 + ((int)(1.0*1000));
    if (pw < 3000 - ((int)(1.0*1000))) pw = 3000 - ((int)(1.0*1000));
    return (int) pw;
}
...
void calculate_analog_sensor_values(void) {
    ...
    primary_voltage.WW = (primaryV.value + 32768) * 18834;
# 254 "../../libUDB/libUDB.c"
}
