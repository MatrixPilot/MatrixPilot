...
int vref_adj ;
# 81 "../../libUDB/analog2digital_udb4.c"
char sampcount = 1 ;
...
void udb_init_gyros( void )
{
 ...
 TRISCbits.TRISC4 = TRISBbits.TRISB14 = 0 ;
 LATCbits.LATC4 = LATBbits.LATB14 = 0 ;
...
# 128 "../../libUDB/analog2digital_udb4.c"
 AD2CSSLbits.CSS1 = 1 ;
 AD2CSSLbits.CSS4 = 1 ;
 AD2CSSLbits.CSS6 = 1 ;
...
# 152 "../../libUDB/analog2digital_udb4.c"
 AD2CSSLbits.CSS15 = 1 ;
...
# 199 "../../libUDB/analog2digital_udb4.c"
inline int lp2(int input, union longww *state) {
    state->WW -= __builtin_mulus((unsigned int)(65536 / 12), state->_.W1);
    state->WW += __builtin_mulus((unsigned int)(65536 / 12), input);
    return (state->_.W1);
}
...
void __attribute__((__interrupt__,__no_auto_psv__)) _ADC2Interrupt(void)
{
 ...
 IFS1bits.AD2IF = 0 ;
# 234 "../../libUDB/analog2digital_udb4.c"
 switch ( sampcount ) {
  case 1 :
   udb_yrate.input = ((int)(ADC2BUF0)) ;
   break;

  case 3 :
   udb_zrate.input = ((int)(ADC2BUF0)) ;
   break;

  case 2 :
   udb_xrate.input = ((int)(ADC2BUF0)) ;
   break;

  case 4 :
   udb_zaccel.input = ((int)(ADC2BUF0)) ;
   break;

  case 5 :
   udb_xaccel.input = -((int)(ADC2BUF0)) ;
   break;

  case 6 :
   udb_yaccel.input = -((int)(ADC2BUF0)) ;
   break;

                case 7 :
                    primaryV.input = ((int)(ADC2BUF0));
                    break;
 ...
 {
  sampcount = 1 ;
# 287 "../../libUDB/analog2digital_udb4.c"
...
# 312 "../../libUDB/analog2digital_udb4.c"
 }
