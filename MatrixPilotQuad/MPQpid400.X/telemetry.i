...
# 1 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/stdio.h" 1 3 4
# 31 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/stdio.h" 3 4
# 1 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/stdarg.h" 1 3 4
...
# 32 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/stdio.h" 2 3 4
# 56 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/stdio.h" 3 4
...
# 77 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/stdio.h" 3 4
extern struct _tfiles {
 char tname[81];
 struct _iobuf * tfp;
} * _tfilesptr;
# 257 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/stdio.h" 3 4
...
# 301 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/stdio.h" 3 4
extern void (*_atexitptr)(void);
# 334 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/stdio.h" 3 4
...
# 390 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/stdio.h" 3 4
extern int sprintf(char *, const char *, ...);
extern int printf(const char *, ...);
# 25 "../telemetry.c" 2
# 1 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/string.h" 1 3 4
# 10 "/opt/microchip/mplabc30/v3.30c/bin/bin/../../include/string.h" 3 4
...
void send_fast_telemetry(void) {
    ...
    if (sendGains) {
        ...
        nbytes = snprintf(debug_buffer, sizeof (debug_buffer), "gains(0:2), %5.3f, %5.3f, %5.3f\r\n",
                (double) (pid_gains[0]) / 0b0100000000000000,
                (double) (pid_gains[1]) / 0b0100000000000000,
                (double) (pid_gains[2]) / 0b0100000000000000
                );
    } else {
# 209 "../telemetry.c"
        nbytes = snprintf(debug_buffer, sizeof (debug_buffer),
                ...
                ( + (( udb_xaccel.value>>1 ) - ( udb_xaccel.offset>>1 ) )), ( + (( udb_yaccel.value>>1 ) - ( udb_yaccel.offset>>1 ) )), ( + (( udb_zaccel.value>>1 ) - ( udb_zaccel.offset>>1 ) )),
        ...
        switch (2) {
            case 0:
                ...
                nbytes = snprintf(debug_buffer, sizeof (debug_buffer), "%5li,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%5i,%6i\r\n",
                        ...
                        commanded_roll, commanded_pitch, commanded_yaw, pwManual[1],
            ...
            case 2:
                ...
                earth_yaw2 = rect_to_polar16(&matrix_accum);
