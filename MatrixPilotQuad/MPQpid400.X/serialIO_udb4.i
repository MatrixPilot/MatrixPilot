...
void udb_gps_set_rate(long rate)
{
 U1BRG = ((int)(((80000000) / 2) / ((long)4 * rate) - 1)) ;
 return ;
}
...
boolean udb_gps_check_rate(long rate)
{
 return ( U1BRG == ((int)(((80000000) / 2) / ((long)4 * rate) - 1)) ) ;
}
...
# 147 "../../libUDB/serialIO_udb4.c"
boolean pauseSerial = 0;
...
void udb_serial_set_rate(long rate)
{
 U2BRG = ((int)(((80000000) / 2) / ((long)4 * rate) - 1)) ;
 return ;
}
...
boolean udb_serial_check_rate(long rate)
{
 return ( U2BRG == ((int)(((80000000) / 2) / ((long)4 * rate) - 1)) ) ;
}
