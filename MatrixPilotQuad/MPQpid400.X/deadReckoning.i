...
extern int cos_lat ;
# 23 "../../libDCM/deadReckoning.c" 2
# 54 "../../libDCM/deadReckoning.c"
int dead_reckon_clock = ((int)(1.1 * (400/((1 == 5) ? 4 : 1)) )) ;
...
{
 if ( dcm_flags._.dead_reckon_enable == 1 )
 {


  IMUintegralAccelerationx.WW += __builtin_mulss( ((int)((((1.0/400)*((long long)980.0)*(4.0*0b0100000000000000))/((long)(5280.0/2.64))))) , accelEarth[0] ) ;
  IMUintegralAccelerationy.WW += __builtin_mulss( ((int)((((1.0/400)*((long long)980.0)*(4.0*0b0100000000000000))/((long)(5280.0/2.64))))) , accelEarth[1] ) ;
  IMUintegralAccelerationz.WW += __builtin_mulss( ((int)((((1.0/400)*((long long)980.0)*(4.0*0b0100000000000000))/((long)(5280.0/2.64))))) , accelEarth[2] ) ;


  IMUlocationx.WW += ( __builtin_mulss( ((int)(((1.0/400)*.01*(4.0*0b0100000000000000)*16.0))) , IMUintegralAccelerationx._.W1 )>>4 ) ;
  IMUlocationy.WW += ( __builtin_mulss( ((int)(((1.0/400)*.01*(4.0*0b0100000000000000)*16.0))) , IMUintegralAccelerationy._.W1 )>>4 ) ;
  IMUlocationz.WW += ( __builtin_mulss( ((int)(((1.0/400)*.01*(4.0*0b0100000000000000)*16.0))) , IMUintegralAccelerationz._.W1 )>>4 ) ;
...

  {
   ...
   IMUintegralAccelerationx.WW += __builtin_mulss( ((int) ((1.0/400)*(4.0*0b0100000000000000)/2.5)) , velocityErrorEarth[0] ) ;
   IMUintegralAccelerationy.WW += __builtin_mulss( ((int) ((1.0/400)*(4.0*0b0100000000000000)/2.5)) , velocityErrorEarth[1] ) ;
   IMUintegralAccelerationz.WW += __builtin_mulss( ((int) ((1.0/400)*(4.0*0b0100000000000000)/2.5)) , velocityErrorEarth[2] ) ;

   IMUlocationx.WW += __builtin_mulss( ((int) ((1.0/400)*(4.0*0b0100000000000000)/2.5)) , locationErrorEarth[0] ) ;
   IMUlocationy.WW += __builtin_mulss( ((int) ((1.0/400)*(4.0*0b0100000000000000)/2.5)) , locationErrorEarth[1] ) ;
   IMUlocationz.WW += __builtin_mulss( ((int) ((1.0/400)*(4.0*0b0100000000000000)/2.5)) , locationErrorEarth[2] ) ;

   IMUvelocityx.WW = IMUintegralAccelerationx.WW +
        __builtin_mulus( ((unsigned int) ((4.0*0b0100000000000000)/2.5)) , 100*locationErrorEarth[0] ) ;
   IMUvelocityy.WW = IMUintegralAccelerationy.WW +
        __builtin_mulus( ((unsigned int) ((4.0*0b0100000000000000)/2.5)) , 100*locationErrorEarth[1] ) ;
   IMUvelocityz.WW = IMUintegralAccelerationz.WW +
        __builtin_mulus( ((unsigned int) ((4.0*0b0100000000000000)/2.5)) , 100*locationErrorEarth[2] ) ;

  }
  else
  {
   errorYawground[0] = errorYawground[1] = errorYawground[2] = 0 ;
   dcm_flags._.gps_history_valid = 0 ;
   IMUvelocityx.WW = IMUintegralAccelerationx.WW ;
   IMUvelocityy.WW = IMUintegralAccelerationy.WW ;
   IMUvelocityz.WW = IMUintegralAccelerationz.WW ;
  }

  if ( dcm_flags._.reckon_req == 1 )
  {

   dcm_flags._.reckon_req = 0 ;
   dead_reckon_clock = ((int)(1.1 * (400/((1 == 5) ? 4 : 1)) )) ;
