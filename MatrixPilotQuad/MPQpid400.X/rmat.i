...
# 23 "../../libDCM/rmat.c" 2
# 41 "../../libDCM/rmat.c"
fractional ggain[] = {4.95*6*(0b0100000000000000*(1.0/400)), 4.95*6*(0b0100000000000000*(1.0/400)), 4.95*6*(0b0100000000000000*(1.0/400))};

unsigned int spin_rate = 0;
fractional spin_axis[] = {0, 0, 0b0100000000000000};
# 69 "../../libDCM/rmat.c"
fractional rmat[] = {0b0100000000000000, 0, 0, 0, 0b0100000000000000, 0, 0, 0, 0b0100000000000000};
fractional rmatDelayCompensated[] = {0b0100000000000000, 0, 0, 0, 0b0100000000000000, 0, 0, 0, 0b0100000000000000};
unsigned long rmatDelayTime;
extern long uptime;
...
union longww gyroCorrectionIntegral[] = {
    { 0},
    { 0},
    { 0}
};
...
fractional gplane[] = {0, 0, ((long)(5280.0/2.64))};


fractional dirovergndHGPS[] = {0, 0b0100000000000000, 0};


fractional dirovergndHRmat[] = {0, 0b0100000000000000, 0};
# 117 "../../libDCM/rmat.c"
...
void dcm_init_rmat(void) {
    ...
    declinationVector[0] = cosine((signed char) (((int)(8.75 *(32767.0 / 180.0))) >> 8));
    declinationVector[1] = sine((signed char) (((int)(8.75 *(32767.0 / 180.0))) >> 8));
...

{
    ...
    omegagyro[0] = ( - ((udb_xrate.value>>1) - (udb_xrate.offset>>1) + vref_adj));
    omegagyro[1] = ( - ((udb_yrate.value>>1) - (udb_yrate.offset>>1) + vref_adj));
    omegagyro[2] = ( - ((udb_zrate.value>>1) - (udb_zrate.offset>>1) + vref_adj));
...
void read_accel() {
    ...
    accelEarth[2] = -((int) ((long)(5280.0/2.64))) + (VectorDotProduct(3, &rmat[6], gplane) << 1);
...
int omegaSOG(int omega, unsigned int speed) {
    ...
    if (((int) working._.W1)> ((int) ((long) (((long long)980.0)*((long long)5632.0/4.95))/(((long)(5280.0/2.64))*((long long)32))))) {
        return 0b0100000000000000;
    } else if (((int) working._.W1) < ((int) -((long) (((long long)980.0)*((long long)5632.0/4.95))/(((long)(5280.0/2.64))*((long long)32))))) {
        return -0b0100000000000000;
    } else {
        working.WW = working.WW >> 5;
        working.WW = __builtin_mulsu(working._.W0, ((long) (((long long)519168.0)*((long)(5280.0/2.64)))/((long long)((long long)5632.0/4.95)*((long long)980.0))));
        working.WW = working.WW << 5;
        return working._.W1;
    }
}
...

{
    ...
    VectorMultiply(3, theta, omega, ggain);

    rup[0] = rup[4] = rup[8] = 0b0100000000000000;
    ...
    nonlinearAdjust = 0b0100000000000000 + ((unsigned int) (thetaSquare >> 14)) / 3;
...

{
    ...
    error = -VectorDotProduct(3, &rmat[0], &rmat[3]);
    ...
    renorm = 0b0110000000000000 - norm;
...
void roll_pitch_drift() {
    ...
    if ((dcm_flags._.rollpitch_req == 1) || (accelerometer_samples > (1.1 * 400))) {
        if (accelerometer_samples > 0) {
            ...
            accelerometer_earth[2] = ((long)(5280.0/2.64));
        }

        if ((0 == 1) || (!gps_nav_valid())) {

            accelerometer_reference[0] = accelerometer_reference[1] = 0;
            accelerometer_reference[2] = 0b0100000000000000;
        } else {
            if (dcm_flags._.rollpitch_req == 1) {
                GPS_acceleration[0] = __builtin_divsd(__builtin_mulsu((GPSvelocity.x - GPS_velocity_previous[0]), 400), accelerometer_samples);
                GPS_acceleration[1] = __builtin_divsd(__builtin_mulsu((GPSvelocity.y - GPS_velocity_previous[1]), 400), accelerometer_samples);
                GPS_acceleration[2] = __builtin_divsd(__builtin_mulsu((GPSvelocity.z - GPS_velocity_previous[2]), 400), accelerometer_samples);
            ...
            accelerometer_reference[0] = GPS_acceleration[0];
            accelerometer_reference[1] = -GPS_acceleration[1];
            accelerometer_reference[2] = 981 + GPS_acceleration[2];
...
void yaw_drift() {
    ...
    if (dcm_flags._.yaw_req) {
        if (ground_velocity_magnitudeXY > 150) {
...
fractional magAlignment[4] = {0, 0, 0, 0b0100000000000000};
...
void align_rmat_to_mag(void) {
    ...
    theta = rect_to_polar(&initialBodyField) - 64 - (((int)(8.75 *(32767.0 / 180.0))) >> 8);
...
void quaternion_adjust(fractional quaternion[], fractional direction[]) {
    ...
    quaternion[0] = __builtin_divsd(__builtin_mulsu(quaternion[0], 0b0100000000000000), magnitude);
    quaternion[1] = __builtin_divsd(__builtin_mulsu(quaternion[1], 0b0100000000000000), magnitude);
    quaternion[2] = __builtin_divsd(__builtin_mulsu(quaternion[2], 0b0100000000000000), magnitude);
    quaternion[3] = __builtin_divsd(__builtin_mulsu(quaternion[3], 0b0100000000000000), magnitude);
...
void RotVector2RotMat(fractional rotation_matrix[], fractional rotation_vector[]) {
    ...
    if (sin_half_alpha_sqr.WW > ((long) 0b0100000000000000 * 0b0100000000000000 - 1)) {
        sin_half_alpha_sqr.WW = (long) 0b0100000000000000 * 0b0100000000000000 - 1;
    }


    sin_half_alpha_sqr.WW *= 8;
    cos_alpha = 0b0100000000000000 - sin_half_alpha_sqr._.W1;
...
# 575 "../../libDCM/rmat.c"
int mag_latency_counter = (400 / 4) - ( ( int ) ( 400 * 0.085 ) );
...
void mag_drift() {
    ...
    if (dcm_flags._.mag_drift_req) {
        ...
        mag_latency_counter = (400 / 4) - ( ( int ) ( 400 * 0.085 ) );
...
void PI_feedback(void) {
    ...
    if (spin_rate < ((unsigned int) (50.0 * ((long long)98.3/4.95)))) {
        kpyaw = 256*4;
        kprollpitch = 256*10;
    } else if (spin_rate < ((unsigned int) (500.0 * ((long long)98.3/4.95)))) {
        kpyaw = ((unsigned int) (256*4 * 8.0 / (50.0 * ((long long)98.3/4.95))))*(spin_rate >> 3);
        kprollpitch = ((unsigned int) (256*10 * 8.0 / (50.0 * ((long long)98.3/4.95))))*(spin_rate >> 3);
    } else {
        kpyaw = (int) (10.0 * 256*4);
        kprollpitch = (int) (10.0 * 256*10);
    }
    ...
    if (spin_rate < ((unsigned int) (20.0 * ((long long)98.3/4.95)))) {
        gyroCorrectionIntegral[0].WW += (__builtin_mulss(errorRP[0], (20400 / 400)) >> 3);
        gyroCorrectionIntegral[1].WW += (__builtin_mulss(errorRP[1], (20400 / 400)) >> 3);
        gyroCorrectionIntegral[2].WW += (__builtin_mulss(errorRP[2], (20400 / 400)) >> 3);

        gyroCorrectionIntegral[0].WW += (__builtin_mulss(errorYawplane[0], (1280 / 400)) >> 3);
        gyroCorrectionIntegral[1].WW += (__builtin_mulss(errorYawplane[1], (1280 / 400)) >> 3);
        gyroCorrectionIntegral[2].WW += (__builtin_mulss(errorYawplane[2], (1280 / 400)) >> 3);
...
unsigned int adjust_gyro_gain(unsigned int old_gain, int gain_change) {
    ...
    if (gain > (unsigned int) (1.1 * 4.95*6*(0b0100000000000000*(1.0/400)))) {
        gain = (unsigned int) (1.1 * 4.95*6*(0b0100000000000000*(1.0/400)));
    }
    if (gain < (unsigned int) (0.9 * 4.95*6*(0b0100000000000000*(1.0/400)))) {
        gain = (unsigned int) (0.9 * 4.95*6*(0b0100000000000000*(1.0/400)));
    }
    return gain;
}
...
void calibrate_gyros(void) {
    ...
    if (spin_rate > (unsigned int) (50.0 * ((long long)98.3/4.95))) {
        ...
        calib_accum = __builtin_mulsu(omegacorrPweighted[0], (unsigned int) ((1.0 / 400) * 4.95*6*(0b0100000000000000*(1.0/400)) / 10.0));
        gain_change = __builtin_divsd(calib_accum, spin_rate_over2);
        ggain[0] = adjust_gyro_gain(ggain[0], gain_change);

        calib_accum = __builtin_mulsu(omegacorrPweighted[1], (unsigned int) ((1.0 / 400) * 4.95*6*(0b0100000000000000*(1.0/400)) / 10.0));
        gain_change = __builtin_divsd(calib_accum, spin_rate_over2);
        ggain[1] = adjust_gyro_gain(ggain[1], gain_change);

        calib_accum = __builtin_mulsu(omegacorrPweighted[2], (unsigned int) ((1.0 / 400) * 4.95*6*(0b0100000000000000*(1.0/400)) / 10.0));
        gain_change = __builtin_divsd(calib_accum, spin_rate_over2);
