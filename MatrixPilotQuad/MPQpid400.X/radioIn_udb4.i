# 1 "../../libUDB/radioIn_udb4.c"
# 1 "/home/markw/Dropbox/autopilots/UAVdevboard/UDB4/mplabx_projects/MPQpid400/MatrixPilotQuad/MPQpid400.X//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libUDB/radioIn_udb4.c"
# 22 "../../libUDB/radioIn_udb4.c"
# 1 "../../libUDB/libUDB_internal.h" 1
# 22 "../../libUDB/libUDB_internal.h"
# 1 "../../libUDB/libUDB.h" 1
# 26 "../../libUDB/libUDB.h"
# 1 "../../MatrixPilotQuad/options.h" 1
# 27 "../../libUDB/libUDB.h" 2
# 1 "../../libUDB/fixDeps.h" 1
# 28 "../../libUDB/libUDB.h" 2
# 1 "../../libUDB/libUDB_defines.h" 1
# 27 "../../libUDB/libUDB_defines.h"
...
# 68 "../../libUDB/libUDB_defines.h" 2
# 1 "../../libUDB/ConfigUDB4.h" 1
# 69 "../../libUDB/libUDB_defines.h" 2
# 100 "../../libUDB/libUDB_defines.h"
# 1 "../../libUDB/boardRotation_defines.h" 1
# 101 "../../libUDB/libUDB_defines.h" 2
# 156 "../../libUDB/libUDB_defines.h"
...
# 226 "../../libUDB/libUDB_defines.h"
extern int magMessage ;
extern int vref_adj ;
# 29 "../../libUDB/libUDB.h" 2
# 1 "../../libUDB/magnetometerOptions.h" 1
# 30 "../../libUDB/libUDB.h" 2
...
# 23 "../../libUDB/radioIn_udb4.c" 2
# 34 "../../libUDB/radioIn_udb4.c"
int udb_pwIn[8 + 1];
int udb_pwTrim[8 + 1];
...
# 67 "../../libUDB/radioIn_udb4.c"
    ...
    TRISDbits.TRISD9 = TRISDbits.TRISD10 = TRISDbits.TRISD11 = TRISDbits.TRISD12 = TRISDbits.TRISD13 = TRISDbits.TRISD14 = TRISDbits.TRISD15 = TRISDbits.TRISD8;


    IPC1bits.IC2IP = IPC9bits.IC3IP = IPC9bits.IC4IP = IPC9bits.IC5IP = IPC10bits.IC6IP = IPC5bits.IC7IP = IPC5bits.IC8IP = IPC0bits.IC1IP;


    IFS0bits.IC2IF = IFS2bits.IC3IF = IFS2bits.IC4IF = IFS2bits.IC5IF = IFS2bits.IC6IF = IFS1bits.IC7IF = IFS1bits.IC8IF = IFS0bits.IC1IF;


    if (8 > 1) IEC0bits.IC2IE = 1;
    if (8 > 2) IEC2bits.IC3IE = 1;
    if (8 > 3) IEC2bits.IC4IE = 1;
    if (8 > 4) IEC2bits.IC5IE = 1;
    if (8 > 5) IEC2bits.IC6IE = 1;
    if (8 > 6) IEC1bits.IC7IE = 1;
    if (8 > 7) IEC1bits.IC8IE = 1;
...
void set_pwIn(int channel, int pw) {
    union longww pww;
    pww.WW = __builtin_muluu(pw, (int) (65536 * 32E6 / (80000000)));
...
void __attribute__((__interrupt__, __no_auto_psv__)) _IC1Interrupt(void) {
    { T5CONbits.TON = 1 ; LATEbits.LATE3 = 0; };
    { __asm__("push CORCON"); CORCON = defaultCorcon; };
    ...
    if (PORTDbits.RD8) {
        ...
        if ((udb_pwIn[1] > 1980) && (udb_pwIn[1] < 4500)) {
            failSafePulses++;
        } else {
            failSafePulses = 0;
    ...
    { T5CONbits.TON = 0 ; LATEbits.LATE3 = 1; __asm__("pop CORCON"); };
    return;
}
