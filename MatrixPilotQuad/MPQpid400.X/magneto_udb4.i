...
int udb_magFieldBody[3] ;
int udb_magOffset[3] = { 0 , 0 , 0 } ;
int magGain[3] = { 0b0100000000000000 , 0b0100000000000000 , 0b0100000000000000 } ;
int rawMagCalib[3] = { 0 , 0 , 0 } ;
unsigned char magreg[6] ;
int magFieldRaw[3] ;
...
# 69 "../../libUDB/magneto_udb4.c"
void udb_init_I2C(void)
{
 TRISAbits.TRISA2 = 0; TRISAbits.TRISA3 = 0 ;
 I2C2BRG = ( (int)(((1/100e3) - 130E-9) * (80000000) / 2)-2 ) ;
 I2C2CONbits.I2CEN = 1 ;
...
void rxMagnetometer(void)
{
 ...
 {
  I2C_state = &I2C_idle ;
                LATAbits.LATA2 = 1; LATAbits.LATA3 = 1 ;
  udb_init_I2C() ;
  magMessage = 0 ;
  return ;
 }

 if ( ((( I2C2CON & 0b0000000000011111 ) == 0) && ( (I2C2STAT & 0b0100010011000001) == 0 )) )
 {
 }
 else
 {
  ...
  IFS3bits.MI2C2IF = 0 ;
  IEC3bits.MI2C2IE = 0 ;
  LATAbits.LATA2 = 0; LATAbits.LATA3 = 0 ;
  return ;
 }
...
void I2C_doneReadMagData(void)
{
 ...
 if ( magMessage == 7 )
 {
  udb_magFieldBody[0] = -((__builtin_mulsu((magFieldRaw[1]), magGain[1] ))>>14)-(udb_magOffset[0]>>1) ;
  udb_magFieldBody[1] = -((__builtin_mulsu((magFieldRaw[0]), magGain[0] ))>>14)-(udb_magOffset[1]>>1) ;
  udb_magFieldBody[2] = -((__builtin_mulsu((magFieldRaw[2]), magGain[2] ))>>14)-(udb_magOffset[2]>>1) ;
  I2C_state = &I2C_idle ;
  if ( ( abs(udb_magFieldBody[0]) < 1500 ) &&
    ( abs(udb_magFieldBody[1]) < 1500 ) &&
    ( abs(udb_magFieldBody[2]) < 1500 ) )
  {
 ...
 else if ( magMessage == 5 )
 {
  for ( vectorIndex = 0 ; vectorIndex < 3 ; vectorIndex++ )
  {
   ...
   if ( ( magFieldRaw[vectorIndex] > 300 ) && ( magFieldRaw[vectorIndex] < 1500 ) )
   {
    magGain[vectorIndex] = __builtin_divud( ((long) ( 700.0*0b0100000000000000)), magFieldRaw[vectorIndex] ) ;
   }
   else
   {
    magGain[vectorIndex] = 0b0100000000000000 ;
    magMessage = 0 ;
   }
  }
  I2C_state = &I2C_idle ;
