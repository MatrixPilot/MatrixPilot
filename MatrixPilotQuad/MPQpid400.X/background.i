...
# 23 "../../libUDB/background.c" 2
# 39 "../../libUDB/background.c"
...
void udb_init_clock(void) {
    ...
    T1CONbits.TCKPS = 1;
    PR1 = ((80000000) / (8 * 2)) / 400;
# 104 "../../libUDB/background.c"
    T1CONbits.TCS = 0;
    IPC0bits.T1IP = 6;
    IFS0bits.T1IF = 0;
    IEC0bits.T1IE = 1;
    ...
    T4CONbits.TON = 0;
# 133 "../../libUDB/background.c"
    TMR5 = 0;
    PR5 = ((80000000) / 20000) - 1;
...
void __attribute__((__interrupt__, __no_auto_psv__)) _T1Interrupt(void) {
    ...
    if (udb_heartbeat_counter % (400 / 2) == 0) {
    ...
    if (udb_heartbeat_counter >= 57600)
...
unsigned char udb_cpu_load(void) {
    ...
    return (unsigned char) (__builtin_muluu(cpu_timer, ((65536.0 * 100.0 * ((80000000) / 20000) * 2) / (80000000))) >> 16);
}
# 257 "../../libUDB/background.c"
...

{
    ...
    if (loopCounter >= (400 / 20)) {
        ...
        if (
            (didCalibrate && !udb_throttle_enable && (abs(udb_pwIn[1] - udb_pwTrim[1] > 100))) ||
            (primary_voltage._.W1 < lowVoltageWarning) ||
            (tailFlash > 0)
            ) {

            LATDbits.LATD4 = 1 - LATDbits.LATD4;
            LATEbits.LATE4 = 1 - LATEbits.LATE4;
            if ((tailFlash > 0) && LATDbits.LATD4) tailFlash--;
        } else {
            LATDbits.LATD4 = 1;
            LATEbits.LATE4 = 1;
        }
