...
extern int cos_lat ;
# 23 "../../libDCM/gpsParseSTD.c" 2
# 33 "../../libDCM/gpsParseSTD.c"
...
void gps_startup_sequence(unsigned int gpscount)
{
 ...
 else if (gpscount == (3 * 400) / 4)

  gpsoutline((char*)bin_mode) ;
 else if (gpscount == 400 / 2)

  gpsoutbin( mode_length , mode ) ;
 else if (gpscount == 400 / 4)

  udb_gps_set_rate(19200);

 return ;
}
# 169 "../../libDCM/gpsParseSTD.c"
int store_index = 0 ;
