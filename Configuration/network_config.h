...
//#define NETWORK_USE_UART1                   (0) // Forward UART1 data  --> SerialIO.c
//#define NETWORK_USE_UART2                   (0) // Forward UART2 data  --> SerialIO.c

//#define NETWORK_USE_LOGO                    (1)  --> flightplan-logo.c

//#define NETWORK_USE_FLYBYDATALINK           (0) // Joystick -> flight surfaces (over the internet!)
