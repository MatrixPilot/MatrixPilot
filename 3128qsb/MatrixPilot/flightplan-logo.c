...
enum {
    ...
    //  NEW PARAMS ///
	ALT_SONAR,	
	ALT_GND_BAROMETER,  //	barometer_gndaltitude = get_barometer_gndaltitude();
	ALT_ASL_BAROMETER,	
	ALT_AGL_BAROMETER,	
	...
	switch (ident) {
		...
		*************************************************/
		case ALT_SONAR: // in centimeters
			...
			{
				int16_t sonar_aglaltitude = -999;  //  return dummy value to trap absence of sonar sensor device in LOGO
		...
		*************************************************/
		case ALT_GND_BAROMETER: // centimeters, above sea level altitude 
			...
			#if ( USE_BAROMETER == 1 )
			{
				return barometer_gndaltitude = get_barometer_gndaltitude(); // in centimeters
			}
			#else   //absence of barometer sensor device
			{
				int16_t barometer_gndaltitude = -999;  //  return dummy value in the absence of sonar sensor device
				return barometer_gndaltitude;
			}
			#endif
		...
		case ALT_ASL_BAROMETER: // centimeters, above sea level altitude 
			...
			#if ( USE_BAROMETER == 1 )
			{
				return barometer_aslaltitude = get_barometer_aslaltitude(); // in centimeters
			}
			#else   //absence of barometer sensor device
			{
				int16_t barometer_aslaltitude = -999;  //  return dummy value in the absence of sonar sensor device
				return barometer_aslaltitude;
			}
			#endif
		...
		case ALT_AGL_BAROMETER: // centimeters, above ground level altitude
			...
			#if ( USE_BAROMETER == 1 )
			{
				return barometer_aglaltitude = get_barometer_aglaltitude(); // in centimeters
			}
			#else   //absence of barometer sensor device
			{
				int16_t barometer_aglaltitude = -999;  //  return dummy value in the absence of sonar sensor device
				return barometer_aglaltitude;
			}
			#endif
		...
		case TEMPERATURE_BAROMETER: // in celcius
			...
			#else   //absence of barometer sensor device
			{
				int16_t barometer_temperature = -999;  //  return dummy value in the absence of sonar sensor device
		...
		case PRESSURE_BAROMETER: // in hPA
			...
			#else   //absence of barometer sensor device
			{
				int16_t barometer_pressure = -999;  //  return dummy value in the absence of sonar sensor device
