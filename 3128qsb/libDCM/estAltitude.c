...
long barometer_aslaltitude;	  // above sea level altitude 
long barometer_aglaltitude;  // mod: above ground level altitude 
long barometer_gndaltitude;  // mod: 
...
inline long get_barometer_gndaltitude(void) { return barometer_gnd_ltitude; }
...
//  :H59,58:t22,p1475,ga24592,ag-27674,as-3082:
	...
	#else
		barometer_gndaltitude = barometer_pressure_gnd ; // SUSPECT ERR ??
		barometer_aglaltitude = (asl_altitude - barometer_gnd_altitude) ;
	#endif
	}
#endif
