...
extern bool sbusDAV;
extern unsigned int byteIndex, sFrameLost, sFailSafe;
#ifdef SBUS_DIAGNOSTICS
extern unsigned int sbusFerr, sbusPerr, sbusFint, sbusCount;
#endif
...
#elif 1
#ifdef SBUS_DIAGNOSTICS
    snprintf(debug_buffer, sizeof (debug_buffer), "tick: %u Ferr: %u Perr: %u Fint: %i Fcount: %u Flost: %i FS: %i cpu: %03i, udb_pwIn: %04i, %04i, %04i, %04i, %04i, %04i, %04i\r\n",
             udb_heartbeat_counter, sbusFerr, sbusPerr, sbusFint, sbusCount, sFrameLost, sFailSafe, cpu_timer, udb_pwIn[1], udb_pwIn[2], udb_pwIn[3], udb_pwIn[4],
             udb_pwIn[5], udb_pwIn[6], udb_pwIn[7]);
#else
    snprintf(debug_buffer, sizeof (debug_buffer), "tick: %u Flost: %i FS: %i udb_pwIn: %04i, %04i, %04i, %04i, %04i, %04i, %04i\r\n",
             udb_heartbeat_counter, sFrameLost, sFailSafe, udb_pwIn[1], udb_pwIn[2], udb_pwIn[3], udb_pwIn[4],
             udb_pwIn[5], udb_pwIn[6], udb_pwIn[7]);
#endif
#endif
