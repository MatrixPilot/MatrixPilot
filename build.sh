...
then
    ...
    ./_build/JSBSimSIL/JSBSimSIL-JSB-Cessna.out --root=Tools/JSBSimSIL --script=scripts/c1723.xml && python Tools/flight_analyzer/flan.pyw --log=log00.txt && google-earth ${PWD}/log00.kmz
