...
mkdir AUAV3 >nul 2>&1
pushd AUAV3
make -f ../../makefile SOURCE_DIR=../.. DEVICE=AUAV3 TOOLCHAIN=C30
popd
mkdir UDB4 >nul 2>&1
pushd UDB4
make -f ../../makefile SOURCE_DIR=../.. DEVICE=UDB4 TOOLCHAIN=C30
popd
mkdir UDB5 >nul 2>&1
pushd UDB5
make -f ../../makefile SOURCE_DIR=../.. DEVICE=UDB5 TOOLCHAIN=C30
popd
