...
int test_ini(void)
{
  ...
  _assert(n==1);
  n = ini_gets("second", "alt", "dummy", str, sizearray(str), inifile);
  _assert(n==9 && strcmp(str,"overwrite")==0);
  /* ----- */
