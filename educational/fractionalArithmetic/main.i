...
int16_t main(void) {
# 56 "main.c"
    long rmax_rmax = __builtin_mulss(0b0100000000000000, 0b0100000000000000);
    ...
    long smax_smax = __builtin_mulss(smax, smax);



    long smin_smax = __builtin_mulss(smin, smax);


    long smin_smin = __builtin_mulss(smin, smin);
    ...
    long umax_smax = __builtin_mulus(umax, smax);


    long umax_smin = __builtin_mulus(umax, smin);





    long umax_umax = __builtin_muluu(umax, umax);
