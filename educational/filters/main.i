# 1 "main.c"
# 1 "/home/markw/MPLABXProjects/gentlenav/branches/MatrixPillotQuad_MarkWhitehorn/educational/filters//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "main.c"
# 9 "main.c"
...
# 1 "../../libUDB/filters.h" 1
# 24 "../../libUDB/filters.h"
# 1 "/opt/microchip/xc16/v1.10/bin/bin/../../include/lega-c/stdlib.h" 1 3 4
# 25 "../../libUDB/filters.h" 2
...
{
    state->WW -= __builtin_mulus((65536 / 12), state->_.W1);


    state->WW += __builtin_mulus((65536 / 12), input);
    return (state->_.W1);
}
