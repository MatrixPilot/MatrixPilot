...
in Python is for developers of MatrixPilot. As these files are already generated,
...
pymavlink libary and a utility call gen_matrixpilot.py . We no longer are
using QGroundControl to generate header files.
...
main MatrixPilot
MAVLink include directories. It will also generate a python
module for both creating and parsing the 
