...
#define \ 
  ...
  MAVLINK_MESSAGE_INFO_SYS_STATUS, \ 
  MAVLINK_MESSAGE_INFO_SYSTEM_TIME, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  MAVLINK_MESSAGE_INFO_PING, \ 
  ...
  MAVLINK_MESSAGE_INFO_PARAM_SET, \ 
  MAVLINK_MESSAGE_INFO_GPS_RAW_INT, \ 
  MAVLINK_MESSAGE_INFO_GPS_STATUS, \ 
  MAVLINK_MESSAGE_INFO_SCALED_IMU, \ 
  MAVLINK_MESSAGE_INFO_RAW_IMU, \ 
  MAVLINK_MESSAGE_INFO_RAW_PRESSURE, \ 
  MAVLINK_MESSAGE_INFO_SCALED_PRESSURE, \ 
  MAVLINK_MESSAGE_INFO_ATTITUDE, \ 
  ...
  MAVLINK_MESSAGE_INFO_SET_LOCAL_POSITION_SETPOINT, \ 
  MAVLINK_MESSAGE_INFO_LOCAL_POSITION_SETPOINT, \ 
  MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_SETPOINT_INT, \ 
  MAVLINK_MESSAGE_INFO_SET_GLOBAL_POSITION_SETPOINT_INT, \ 
  MAVLINK_MESSAGE_INFO_SAFETY_SET_ALLOWED_AREA, \ 
  MAVLINK_MESSAGE_INFO_SAFETY_ALLOWED_AREA, \ 
  MAVLINK_MESSAGE_INFO_SET_ROLL_PITCH_YAW_THRUST, \ 
  MAVLINK_MESSAGE_INFO_SET_ROLL_PITCH_YAW_SPEED_THRUST, \ 
  MAVLINK_MESSAGE_INFO_ROLL_PITCH_YAW_THRUST_SETPOINT, \ 
  MAVLINK_MESSAGE_INFO_ROLL_PITCH_YAW_SPEED_THRUST_SETPOINT, \ 
  MAVLINK_MESSAGE_INFO_SET_QUAD_MOTORS_SETPOINT, \ 
  MAVLINK_MESSAGE_INFO_SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST, \ 
  MAVLINK_MESSAGE_INFO_NAV_CONTROLLER_OUTPUT, \ 
  MAVLINK_MESSAGE_INFO_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST, \ 
  MAVLINK_MESSAGE_INFO_STATE_CORRECTION, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  MAVLINK_MESSAGE_INFO_REQUEST_DATA_STREAM, \ 
  MAVLINK_MESSAGE_INFO_DATA_STREAM, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  ...
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  MAVLINK_MESSAGE_INFO_VFR_HUD, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  MAVLINK_MESSAGE_INFO_COMMAND_LONG, \ 
  MAVLINK_MESSAGE_INFO_COMMAND_ACK, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  MAVLINK_MESSAGE_INFO_ROLL_PITCH_YAW_RATES_THRUST_SETPOINT, \ 
  ...
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  MAVLINK_MESSAGE_INFO_FILE_TRANSFER_START, \ 
  MAVLINK_MESSAGE_INFO_FILE_TRANSFER_DIR_LIST, \ 
  MAVLINK_MESSAGE_INFO_FILE_TRANSFER_RES, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  ...
  MAVLINK_MESSAGE_INFO_SETPOINT_8DOF, \ 
  MAVLINK_MESSAGE_INFO_SETPOINT_6DOF, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}, \ 
  ...
  MAVLINK_MESSAGE_INFO_NAMED_VALUE_INT, \ 
  MAVLINK_MESSAGE_INFO_STATUSTEXT, \ 
  MAVLINK_MESSAGE_INFO_DEBUG, \ 
  {"EMPTY",0,{{"","",MAVLINK_TYPE_CHAR,0,0,0}}}}
 */
