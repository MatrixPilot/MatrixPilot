...
#define MAVLINK_MSG_ID_SERIAL_UDB_EXTRA_F13 172
...
typedef struct __mavlink_serial_udb_extra_f13_t
{
 ...
 int16_t sue_alt_origin; ///< Serial UDB Extra MP Origin Altitude Above Sea Level
} mavlink_serial_udb_extra_f13_t;

#define MAVLINK_MSG_ID_SERIAL_UDB_EXTRA_F13_LEN 12
...
#define MAVLINK_MESSAGE_INFO_SERIAL_UDB_EXTRA_F13 { \
	...
	{  { "sue_lat_origin", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_serial_udb_extra_f13_t, sue_lat_origin) }, \
         ...
         { "sue_week_no", NULL, MAVLINK_TYPE_INT16_T, 0, 8, offsetof(mavlink_serial_udb_extra_f13_t, sue_week_no) }, \
         { "sue_alt_origin", NULL, MAVLINK_TYPE_INT16_T, 0, 10, offsetof(mavlink_serial_udb_extra_f13_t, sue_alt_origin) }, \
         } \
}
...
static inline uint16_t mavlink_msg_serial_udb_extra_f13_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       int16_t sue_week_no, int32_t sue_lat_origin, int32_t sue_lon_origin, int16_t sue_alt_origin)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_int32_t(buf, 0, sue_lat_origin);
	_mav_put_int32_t(buf, 4, sue_lon_origin);
	_mav_put_int16_t(buf, 8, sue_week_no);
	_mav_put_int16_t(buf, 10, sue_alt_origin);
	...
	return mavlink_finalize_message(msg, system_id, component_id, 12, 169);
}
						           ...
						           int16_t sue_week_no,int32_t sue_lat_origin,int32_t sue_lon_origin,int16_t sue_alt_origin)
{
	...
	msg->msgid = MAVLINK_MSG_ID_SERIAL_UDB_EXTRA_F13;
	return mavlink_finalize_message_chan(msg, system_id, component_id, chan, 12, 169);
}
...
static inline void mavlink_msg_serial_udb_extra_f13_send(mavlink_channel_t chan, int16_t sue_week_no, int32_t sue_lat_origin, int32_t sue_lon_origin, int16_t sue_alt_origin)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_int32_t(buf, 0, sue_lat_origin);
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SERIAL_UDB_EXTRA_F13, buf, 12, 169);
#else
	mavlink_serial_udb_extra_f13_t packet;
	packet.sue_lat_origin = sue_lat_origin;
	packet.sue_lon_origin = sue_lon_origin;
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SERIAL_UDB_EXTRA_F13, (const char *)&packet, 12, 169);
#endif
}
 ...
 */
static inline int16_t mavlink_msg_serial_udb_extra_f13_get_sue_alt_origin(const mavlink_message_t* msg)
{
...
#else
	memcpy(serial_udb_extra_f13, _MAV_PAYLOAD(msg), 12);
#endif
}
