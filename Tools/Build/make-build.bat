...
pyProjectCreator.py -t UDB4  -o ../../build -c ../../Config -d Config -d MatrixPilot -d libCntrl -d libUDB -d libDCM -d libFlashFS -d libVectorMatrix -d MAVLink -d Microchip -d Tools/MatrixPilot-SIL
pyProjectCreator.py -t UDB5  -o ../../build -c ../../Config -d Config -d MatrixPilot -d libCntrl -d libUDB -d libDCM -d libFlashFS -d libVectorMatrix -d MAVLink -d Microchip -d Tools/MatrixPilot-SIL
pyProjectCreator.py -t AUAV3 -o ../../build -c ../../Config -d Config -d MatrixPilot -d libCntrl -d libUDB -d libDCM -d libFlashFS -d libVectorMatrix -d MAVLink -d Microchip -d Tools/MatrixPilot-SIL
...
@rem copy build-auav3.bat ../../build
@rem copy build-silsim.bat ../../build
