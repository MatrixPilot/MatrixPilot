...
class MAVLink_param_request_read_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 39, struct.pack('<hBB15s', self.param_index, self.target_system, self.target_component, self.param_id))
...
class MAVLink_param_value_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 205, struct.pack('<fHH15s', self.param_value, self.param_count, self.param_index, self.param_id))
...
class MAVLink_param_set_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 244, struct.pack('<fBB15s', self.param_value, self.target_system, self.target_component, self.param_id))
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_PARAM_REQUEST_READ : ( '<hBB15s', MAVLink_param_request_read_message, [1, 2, 3, 0], 39 ),
        MAVLINK_MSG_ID_PARAM_REQUEST_LIST : ( '<BB', MAVLink_param_request_list_message, [0, 1], 159 ),
        MAVLINK_MSG_ID_PARAM_VALUE : ( '<fHH15s', MAVLink_param_value_message, [3, 0, 1, 2], 205 ),
        MAVLINK_MSG_ID_PARAM_SET : ( '<fBB15s', MAVLink_param_set_message, [1, 2, 3, 0], 244 ),
        MAVLINK_MSG_ID_GPS_RAW_INT : ( '<QiiiffffB', MAVLink_gps_raw_int_message, [0, 8, 1, 2, 3, 4, 5, 6, 7], 180 ),
        ...
        MAVLINK_MSG_ID_GPS_RAW : ( '<QfffffffB', MAVLink_gps_raw_message, [0, 8, 1, 2, 3, 4, 5, 6, 7], 220 ),
        MAVLINK_MSG_ID_SYS_STATUS : ( '<HHHHBBB', MAVLink_sys_status_message, [4, 5, 6, 0, 1, 2, 3], 64 ),
        ...
        MAVLINK_MSG_ID_SET_ALTITUDE : ( '<IB', MAVLink_set_altitude_message, [1, 0], 54 ),
        ...
        MAVLINK_MSG_ID_COMMAND : ( '<ffffBBBB', MAVLink_command_message, [4, 5, 6, 7, 0, 1, 2, 3], 133 ),
        ...
        MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT : ( '<IffHB20sB', MAVLink_object_detection_event_message, [0, 3, 4, 5, 6, 1, 2], 179 ),
