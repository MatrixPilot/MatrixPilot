...
#include "USB/usb_function_msd.h"
    ...
    #define LUNMediaInitialize()                MDD_AT45D_MediaInitialize()
    #define LUNReadCapacity()                   MDD_AT45D_ReadCapacity()
    #define LUNReadSectorSize()                 MDD_AT45D_ReadSectorSize()
    #define LUNMediaDetect()                    MDD_AT45D_MediaDetect()
    #define LUNSectorWrite(bLBA,pDest,Write0)   MDD_AT45D_SectorWrite(bLBA, pDest, Write0)
    #define LUNWriteProtectState()              MDD_AT45D_WriteProtectState()
    #define LUNSectorRead(bLBA,pSrc)            MDD_AT45D_SectorRead(bLBA, pSrc)
