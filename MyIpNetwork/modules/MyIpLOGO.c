...
//itoaSrc
  ...
  case Execute_Mission:
    ...
    // You must be in Waypoint mode (not RTL) *BEFORE* this is received to execute.
    // Disabling waypoint mode and re-enabling it will start the hardcoded waypoint as usual
    init_flightmission(header.mission, header.indexCmd);
    break;
  ...
  case Resume_Mission:
    ...
    init_flightmission(header.mission, getLogoCmdIndex(header.mission));
    break;
