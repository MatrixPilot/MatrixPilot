...
unsigned int16_t I2C1_Index = 0;  		// index into the write buffer

unsigned char I2C1_CommandByte 	= 0;
unsigned int16_t I2C1_tx_data_size = 0;		// tx data size
unsigned int16_t I2C1_rx_data_size = 0;		// rx data size
unsigned int16_t I2C1_command_data_size = 0;	// command data size

unsigned char* pI2C1Buffer = NULL;	// pointer to buffer
unsigned char* pI2C1commandBuffer = NULL;	// pointer to receive  buffer

unsigned int16_t I2C1_service_handle = INVALID_HANDLE;
