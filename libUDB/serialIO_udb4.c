...
void __attribute__((__interrupt__,__no_auto_psv__)) _U1TXInterrupt(void)
{
	...
	interrupt_save_set_corcon(U1TX_INT, 0) ;
	...
	interrupt_restore_corcon(U1TX_INT, 0) ;
}
...
void __attribute__((__interrupt__, __no_auto_psv__)) _U1RXInterrupt(void)
{
	...
	indicate_loading_inter ;
	interrupt_save_set_corcon(U1RX_INT, 0) ;
	...
	interrupt_restore_corcon(U1RX_INT, 0) ;
}
...
void __attribute__((__interrupt__,__no_auto_psv__)) _U2TXInterrupt(void)
{
	...
	indicate_loading_inter ;
	interrupt_save_set_corcon(U2TX_INT, 0) ;	
	...
	interrupt_restore_corcon(U2TX_INT, 0) ;
}
...
void __attribute__((__interrupt__, __no_auto_psv__)) _U2RXInterrupt(void)
{
	...
	indicate_loading_inter ;
	interrupt_save_set_corcon(U2RX_INT, 0) ;
	...
	interrupt_restore_corcon(U2RX_INT, 0) ;
}
