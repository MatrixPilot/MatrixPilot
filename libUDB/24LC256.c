...
unsigned int16_t MCP24LC256_state = MCP24LC256_STATE_STOPPED;

unsigned int16_t 	MCP24LC256_write_address;
unsigned int16_t 	MCP24LC256_write_size;
unsigned char* 	MCP24LC256_pwrBuffer = NULL;

unsigned int16_t 	MCP24LC256_Timer = 0;
...
unsigned int16_t nv_memory_service_handle = INVALID_HANDLE;
