...
#if(CAN_PORT == 1)
        #define CiCFG1          C1CFG1
        #define CiCFG2          C1CFG2

        #define CiFEN1          C1FEN1
        #define CiRXF0SID       C1RXF0SID
        #define CiRXF1SID       C1RXF1SID
        #define CiRXF2SID       C1RXF2SID
        #define CiRXF3SID       C1RXF3SID
        #define CiRXF4SID       C1RXF4SID
        #define CiRXF5SID       C1RXF5SID
        #define CiRXF6SID       C1RXF6SID
        #define CiRXF7SID       C1RXF7SID
        #define CiRXF8SID       C1RXF8SID
        #define CiRXF9SID       C1RXF9SID
        #define CiRXF10SID      C1RXF10SID

        #define CiRXF0EID       C1RXF0EID
        #define CiRXF1EID       C1RXF1EID
        #define CiRXF2EID       C1RXF2EID
        #define CiRXF3EID       C1RXF3EID
        #define CiRXF4EID       C1RXF4EID
        #define CiRXF5EID       C1RXF5EID
        #define CiRXF6EID       C1RXF6EID
        #define CiRXF7EID       C1RXF7EID
        #define CiRXF8EID       C1RXF8EID
        #define CiRXF9EID       C1RXF9EID
        #define CiRXF10EID      C1RXF10EID

        #define CiRXM0SID       C1RXM0SID
        #define CiRXM1SID       C1RXM1SID
        #define CiRXM2SID       C1RXM2SID

        #define CiRXM0EID       C1RXM0EID
        #define CiRXM1EID       C1RXM1EID
        #define CiRXM2EID       C1RXM2EID

        #define CiFMSKSEL1      C1FMSKSEL1
