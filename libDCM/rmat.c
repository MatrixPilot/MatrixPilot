...
int omegaSOG ( int16_t omega , uint16_t speed  )
{
...
long int16_t accelerometer_earth_integral[3] = { 0 , 0 , 0 } ;
int GPS_velocity_previous[3] = { 0 , 0 , 0 } ;
unsigned int16_t accelerometer_samples = 0 ;
...
unsigned int16_t adjust_gyro_gain ( uint16_t old_gain , int16_t gain_change )
{
	uint16_t gain ;
