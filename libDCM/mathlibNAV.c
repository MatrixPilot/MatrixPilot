...
unsigned int16_t sqrt_int( uint16_t sqr )
{
...
unsigned int16_t sqrt_long( uint32_t int16_t sqr )
{
	// based on Heron's algorithm
	uint16_t binary_point = 0 ;
...
unsigned int16_t vector2_mag( int16_t x , int16_t y )
{
	int32_t uint16_t magsqr ;
	magsqr = __builtin_mulss( x , x ) + __builtin_mulss( y , y ) ;
	return sqrt_long( magsqr )	;
}

unsigned int16_t vector3_mag( int16_t x , int16_t y , int16_t z )
{
	int32_t uint16_t magsqr ;
